        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          <div className="space-y-4 max-w-2xl">
            <div className="inline-flex items-center gap-2 text-xs font-bold text-emerald-800 uppercase tracking-wider bg-emerald-50 px-3 py-1 rounded-full border border-emerald-200/60">
              ...
              <span>KURIKULUM BERKARAKTER &amp; DINAMIS</span>
            </div>
            ...
            <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight leading-[1.2] font-['Plus_Jakarta_Sans',sans-serif]">
              Kegiatan &amp; Eksplorasi Santri Unggulan
            </h1>

            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              Menghidupkan adab Qur'ani, kecakapan intelektual, ketahanan fisik, dan kreativitas mandiri melalui pembiasaan harian terpadu dan ragam ekstrakurikuler aplikatif di Playen.
            </p>
          </div>
        ...
        <div className="bg-emerald-950 rounded-2xl sm:rounded-3xl text-white p-6 sm:p-8 shadow-xl">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 divide-y lg:divide-y-0 lg:divide-x divide-emerald-900/80">
            <div className="flex items-center gap-4 pt-4 first:pt-0 lg:pt-0 lg:px-4">
              ...
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-white">07.00</div>
                <div className="text-xs text-emerald-300">Mulai Halaqah Pagi</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 lg:pt-0 lg:px-4">
              ...
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-white">30 Juz</div>
                <div className="text-xs text-emerald-300">Bimbingan Tajwid Sanad</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 lg:pt-0 lg:px-4">
              ...
              <div>
                ...
                <div className="text-xs text-emerald-300">Praktik Lapangan Sunnah</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 lg:pt-0 lg:px-4">
              ...
              <div>
                ...
                <div className="text-xs text-emerald-300">Pendampingan Karakter</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {(activeTab === 'semua' || activeTab === 'harian') && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs hover:shadow-md transition-shadow">
              <div className="relative h-48 bg-slate-100">
                <img
                  src="https://images.unsplash.com/photo-1564769625905-50e93615e769?auto=format&fit=crop&w=600&q=80"
                  alt="Sholat Dhuha"
              ...
              <div className="p-6 space-y-3">
                <h4 className="text-base font-bold text-slate-900">
                  Sholat Dhuha &amp; Berjamaah Terbimbing
                </h4>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Pembiasaan shalat sunnah Dhuha setiap pagi serta shalat Dzuhur &amp; Ashar berjamaah dengan adab masjid lengkap.
                </p>
                <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-500 pt-2 border-t border-slate-100">
                  <Clock className="w-3.5 h-3.5 text-emerald-800" />
                  <span>Setiap Hari (07.15 &amp; Dzuhur)</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs hover:shadow-md transition-shadow">
              <div className="relative h-48 bg-slate-100">
                <img
                  ...
                  className="w-full h-full object-cover"
                />
                <span className="absolute top-3 left-3 bg-amber-600/90 text-white text-[10px] font-bold px-2.5 py-1 rounded-md uppercase">
                  TAHFIDZ
                </span>
              </div>
              <div className="p-6 space-y-3">
                <h4 className="text-base font-bold text-slate-900">
                  Halaqah Tahfidz &amp; Talaqqi Pagi
                </h4>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Metode setoran hafalan baru (ziyadah) dengan rasio 1 ustadz mendampingi maksimal 10–12 santri secara intensif.
                </p>
                <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-500 pt-2 border-t border-slate-100">
                  <Clock className="w-3.5 h-3.5 text-emerald-800" />
                  <span>Senin – Jumat (07.30 – 08.45)</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs hover:shadow-md transition-shadow">
              <div className="relative h-48 bg-slate-100">
                <img
                  ...
                  className="w-full h-full object-cover"
                />
                <span className="absolute top-3 left-3 bg-indigo-600/90 text-white text-[10px] font-bold px-2.5 py-1 rounded-md uppercase">
                  KARAKTER
                </span>
              </div>
              <div className="p-6 space-y-3">
                <h4 className="text-base font-bold text-slate-900">
                  Kultum Dhuha &amp; Muroja'ah Akbar
                </h4>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Latihan public speaking santri bergiliran membawakan nasihat hadits singkat, dilanjutkan muroja'ah bersama satu juz.
                </p>
                <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-500 pt-2 border-t border-slate-100">
                  <Clock className="w-3.5 h-3.5 text-emerald-800" />
                  <span>Jumat Pagi (07.15 – 08.15)</span>
                </div>
              </div>
            </div>
      ...
      {(activeTab === 'semua' || activeTab === 'berkala') && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs flex flex-col justify-between">
              <div>
                <img
                  src="https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=500&q=80"
                  alt="Mukhayyam Al-Quran"
                ...
                <div className="p-5 space-y-2">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Karantina intensif 3 hari di alam terbuka Playen untuk akselerasi kelancaran mutqin.
                  </p>
                </div>
              </div>
              <div className="p-5 pt-0 text-[11px] font-semibold text-slate-500 flex items-center gap-1.5">
                <Calendar className="w-3.5 h-3.5 text-emerald-800" />
                <span>1x Tiap Semester</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs flex flex-col justify-between">
              <div>
                ...
                <div className="p-5 space-y-2">
                  ...
                  <h4 className="text-sm font-bold text-slate-900">
                    Market Day Entrepreneur
                  </h4>
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Praktik muamalah Islami, kejujuran timbangan, literasi keuangan dasar, dan sedekah.
                  </p>
                </div>
              </div>
              <div className="p-5 pt-0 text-[11px] font-semibold text-slate-500 flex items-center gap-1.5">
                <Calendar className="w-3.5 h-3.5 text-amber-700" />
                <span>Tengah Semester</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs flex flex-col justify-between">
              <div>
                ...
                />
                <div className="p-5 space-y-2">
                  <span className="text-[10px] font-bold text-teal-800 bg-teal-50 px-2 py-0.5 rounded-md uppercase">
                    RISET ALAM
                  </span>
                  <h4 className="text-sm font-bold text-slate-900">
                    Outing Class &amp; Tadabbur Alam
                  </h4>
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Kunjungan edukasi riset ke kawasan geopark, hutan Wanagama, serta sentra sains.
                  </p>
                </div>
              </div>
              <div className="p-5 pt-0 text-[11px] font-semibold text-slate-500 flex items-center gap-1.5">
                <Calendar className="w-3.5 h-3.5 text-teal-700" />
                <span>Setiap Akhir Tema</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs flex flex-col justify-between">
              <div>
                ...
                />
                <div className="p-5 space-y-2">
                  <span className="text-[10px] font-bold text-rose-800 bg-rose-50 px-2 py-0.5 rounded-md uppercase">
                    SOSIAL
                  </span>
                  <h4 className="text-sm font-bold text-slate-900">
                    Peringatan PHBI &amp; Baksos
                  </h4>
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Penyembelihan qurban santri, festival Muharram, pembagian sembako dhuafa sekitar Playen.
                  </p>
                </div>
              </div>
              <div className="p-5 pt-0 text-[11px] font-semibold text-slate-500 flex items-center gap-1.5">
            ...
            {settings.extracurriculars && settings.extracurriculars.length > 0 ? (
              settings.extracurriculars.map((ekskul, idx) => {
                const images = [
                  ...
                  "https://images.unsplash.com/photo-1581093458791-9f3c3900df4b?auto=format&fit=crop&w=500&q=80"
                ];
                const badges = ["QUR'AN & ADAB", "BELA DIRI", "OLAHRAGA SUNNAH", "KEPANDUAN & ALAM", "AKADEMIK"];
                return (
                  <div key={ekskul.id || idx} className="bg-white rounded-3xl p-5 border border-slate-200/80 shadow-xs space-y-3 flex flex-col justify-between">
                    ...
                    <div className="text-[11px] font-semibold text-slate-500 pt-2 border-t border-slate-100 flex items-center gap-1.5">
                      <Clock className="w-3.5 h-3.5 text-emerald-800" />
                      <span>Program Ekstrakurikuler Pilihan</span>
                    </div>
                  </div>
                );
              })
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <h3 className="text-xl sm:text-2xl font-extrabold text-slate-900">
              Agenda Kegiatan Semester Berjalan
            </h3>
            <p className="text-xs text-slate-500">
              Jadwal kegiatan penting santri SDQU Al I'tisham Playen semester genap.
            </p>
          </div>
          ...
          >
            ...
            <span>Unduh Kalender Format PDF</span>
          </a>
        </div>
