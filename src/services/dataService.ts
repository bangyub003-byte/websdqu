...
class DataService {
  ...
  constructor() {
    ...
    this.settings = {
      ...
      profilLegalitas: loadedSettings?.profilLegalitas?.length ? loadedSettings.profilLegalitas : INITIAL_SETTINGS.profilLegalitas,
      dailyActivities: loadedSettings?.dailyActivities?.length ? loadedSettings.dailyActivities : INITIAL_SETTINGS.dailyActivities,
      periodicPrograms: loadedSettings?.periodicPrograms?.length ? loadedSettings.periodicPrograms : INITIAL_SETTINGS.periodicPrograms,
      fasilitasEcoItems: loadedSettings?.fasilitasEcoItems?.length ? loadedSettings.fasilitasEcoItems : INITIAL_SETTINGS.fasilitasEcoItems,
      infaqPrograms: loadedSettings?.infaqPrograms?.length ? loadedSettings.infaqPrograms : INITIAL_SETTINGS.infaqPrograms,
      spmbSteps: loadedSettings?.spmbSteps?.length ? loadedSettings.spmbSteps : INITIAL_SETTINGS.spmbSteps,
      spmbDocsList: loadedSettings?.spmbDocsList?.length ? loadedSettings.spmbDocsList : INITIAL_SETTINGS.spmbDocsList,
      spmbFaqs: loadedSettings?.spmbFaqs?.length ? loadedSettings.spmbFaqs : INITIAL_SETTINGS.spmbFaqs,
